$("document").ready(function () {
  ...
  let s_id = $('#s_id').html
  let s_password = $('#s_pa').html
  let s_submit = $('#s_sub')
  let s_message = $('#s_message')
  ...
  form_student.addEventListener('click', login(s_id, s_password))
  console.log(s_password)
  function login(id, password) {
    if (id == e_number && password == s_password) {
      Swal.fire({
        position: 'top',
        icon: 'success',
      ...
      s_message.innerHTML = "Plz check your credentials"
    }
